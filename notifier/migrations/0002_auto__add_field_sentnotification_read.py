...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SentNotification.read'
        db.add_column(u'notifier_sentnotification', 'read',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SentNotification.read'
        db.delete_column(u'notifier_sentnotification', 'read')
